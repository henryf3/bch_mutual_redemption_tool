...
export const extendedJsonReplacer = function (value) {
    switch (typeof value) {
        case 'bigint':
...
export const extendedJsonReviver = function (value) {
...
export const encodeExtendedJsonObject = function (value) {
...
export const decodeExtendedJsonObject = function (value) {
    // If this is an object type (and it is not null - which is technically an "object")...
    if (typeof value === 'object' && value !== null) {
        // If this is an array, recursively call this function on each value.
        if (Array.isArray(value)) {
